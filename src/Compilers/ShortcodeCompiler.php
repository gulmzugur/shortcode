...
namespace Squirtle\Shortcode\Compilers;
...
class ShortcodeCompiler
{
     ...
     * @since 2.1
     */
    public function add(string $key, string $name, $description = null, $callback = null)
    {
     ...
     * @return string
     */
    protected function renderShortcodes($value): string
    {
     ...
     * @return string
     */
    public function getShortcodeNames(): string
    {
    ...
    {
        $this->registered[$key]['config'] = $value;
    }
}
